...
<label>HS/AAU Name:</label><span>	<input type="text" name="txtfldName" id="txtfldName" class="yellow"><font color="#0000ff">&nbsp;*</font></span><label>Address:</label><span> 	<textarea rows=14 cols=69 name=fldAddress></textarea><font color="#0000ff">&nbsp;*</font></span><br/><br/><label>City:</label><span>	<input type="text" name="fldCity" id="fldCity" value="" >	<font color="#0000ff">&nbsp;*</font></span><br/><br/><label>State:</label>    <span>
