...
define(TBL_POS_FOOTBALL,'tbl_position_football');
define(TBL_POS_BASKETBALL,'tbl_position_basketball');
##################### TABLES END #######################################################################################
define(SITE_URL,"http://www.CollegeProspectNetwork.com/"); // example.com can be replace with your domain
define(ADMIN_URL,"http://www.CollegeProspectNetwork.com/admin/");  // example.com can be replace with your domain
