...
class COMMONFUNC {
    ...
    //echo $_REQUEST['cid']; to calculate latitude and longitude
...
and sp.sportid=".$id;
    ...
    function sendEmail($toStr,$subjectStr,$bodyStr,$fromStr) {
        ...
        $header .= "Content-type: text/html; charset=iso-8859-1\n"; # use text/palin for plain mail and text/html for html mail
        $header .="From: < $from_email >\n";
        
        $to_email = $toStr;
        if(!mail($to_email,$subjectStr,$bodyStr,$header) ) {
