...
function validate(){
    ...
    if(trimString(document.frmCatagory.fldParentId.value) == "select"){
    ...
    if(trimString(document.frmCatagory.fldName.value) == ""){
		error_msg += "Please Enter Category Name! \n";
	}
	else{
...
<HTML><HEAD><TITLE>Add Athlete Category Stats Info</TITLE>
...
<!-- MAin Content Starts From Here -->
			...
			<td valign="top" class="normalwhite_14" colspan=3 bgcolor="#808080" align="center">
				<b>Add Athlete Stats Category</b>
			</td>
			</tr>
			<tr>
			<!-- Display the message on heading of the page -->
			...
			<tr height="20">
			<td valign="top" align="right" class="normalblack_12" width="40%">Sports<font color="red"> *</font> </td>
			...
			<?php echo '<select name="fldParentId" id="fldParentId" style="width:220px" onChange="getSportID(this.value);" ><option value="select">Please Select</option>';
