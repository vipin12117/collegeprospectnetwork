...
if($_POST['isSubmit']=='save'){
		...
		if($db->MatchingRec(TBL_COLLEGE,$whereClause)>0) {    #user Username already exists
        ...
        if($flag==0){
			...
			'fldContactInfo' 		=> $func->input_fun($_POST['fldContactInfo']),
	 		...
	 		$db->insertRec(TBL_COLLEGE,$strDataArr);
       
		
			header("Location: ADTeamList.php?msg=College is Added Successfully, ");
		}
