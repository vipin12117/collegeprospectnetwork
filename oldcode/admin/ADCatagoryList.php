...
function deleteRecord(fldId,page) {
	...
	if( confirm("Are you sure to delete the Catagory?")) {
...
function submitDeleteAll(){
	...
	if(countChecked!=0){
		if( confirm("Are you sure to delete the selected Catagory?")) {
		...
		alert("Please select at least one Catagory to delete");
		return false;
	}
			...
			<TD bgColor=#ffffff>
				...
				<!--Main Center Content BEGIN -->
						...
						<table border="1" cellpadding="1" cellspacing="0" width="100%" bordercolor="#808080" style="border-collapse:collapse" class="tablePadd"> 
							...
							<strong>Catagories Listing</strong> </td></tr>
				...
				<input type="hidden" name="page" id="page" value="0">
						...
						<?
						if(!$searchname){
						$query =" Select * from ".TBL_CATAGORY; }else{
						$query ="Select * from ".TBL_CATAGORY." where 1=1 ".$srchCond;
						}
						...
						echo '<tr><td align="center" class="normalblack_12" width="4%">&nbsp;</td>
									...
									<td align="left" class="normalblack_12" width="25%">&nbsp;<strong>Catagory Name</strong></td>
                                   ';
						...
						for ($i=0;$i<$db->num_rows();$i++) {
							...
							$pageURL            = "ADCatagoryDetails.php?fldId=$fldId";
							$detailsWindowTitle = "Sports Catagory Details";
							...
							echo '<tr><td align="center" class="normalblack_12">&nbsp;';
									...
									';
							   		...
							   		echo '<td class="normalblack_12" align="center"><a href="ADCatagoryEdit.php?mode=edit&fldId='.$db->f('fldId').'&page='.$pageno.'"><img src="images/b_edit.png" border="0" title="Edit"></a></td>';
