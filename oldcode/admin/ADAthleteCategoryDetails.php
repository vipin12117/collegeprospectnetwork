		...
		<tr>
		<td class="normalblack_12" valign="top" height="25" width="40%"><b>Category Name</b> </td>
		<td class="normalblack_12" valign="top"><?=$db->f('fldName');?></td>
		</tr>
		
		 <tr>
		<td class="normalblack_12" valign="top" height="25" width="40%"><b>Sports</b> </td>
		<?php
		$parentId=$db->f('fldParentId');
$query_parent =" Select * from ".TBL_SPORTS. " where fldId = '$parentId' ";

		$db1->query($query_parent);
		$db1->next_record();
		?>
		<td class="normalblack_12" valign="top"><?=$db1->f('fldSportsname')?></td>
		</tr>
