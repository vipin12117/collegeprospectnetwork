...
if($_POST['isSubmit']=='save'){
        ...
        //Edit the Transportation Discount
		$id   	     	 = $func->input_fun($_POST['id']);
        ...
        if($flag==0){
			//Insert Transportation Discount
	 		...
	 		$db->insertRec($tbl_transportation_discount,$strDataArr);
       
			#redirect to listing page on successfull updation
			
			header("Location: ADTransportationManage.php?msg=Transportation Discount is Added Successfully ");
		}
	if($error_msg!=""){
...
<!-- MAin Content Starts From Here -->
			<form name="frmtransport" action="" method="post" enctype="multipart/form-data"  id="frmtransport">
			...
			<td valign="top" class="normalwhite_14" colspan=3 bgcolor="#808080" align="center">
				<b>Add Transportation Discount</b>
			</td>
			</tr>
			<tr>
			<!-- Display the message on heading of the page -->
			...
			<?php /*?><input type="text" name="Departure_Time" id="Departure_Time" value="<?=$Departure_Time?>" style="width: 220px;"><?php */?></td>
			</tr>
