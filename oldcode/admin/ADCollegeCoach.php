...
if($_POST['isSubmit']=='save'){
		...
		$whereClause = "fldUserName='".$fldUserName."'  or fldEmail='$fldEmail'";
        ...
        if($flag==0)
        {
			...
			$db->insertRec(TBL_COLLEGE_COACH_REGISTER,$strDataArr);
			...
			header("Location: ADCollegeCoachList.php?msg=$collegename College is Added Successfully, ");
		}
...
<!-- MAin Content Starts From Here -->
			...
			<tr height="20">
			<td valign="top" align="right" class="normalblack_12" width="30%">Divison<font color="red"> *</font></td>
			<td valign="top"  align="center" class="normalblack_12" > : </td>
