			...
			<TD bgColor=#ffffff>
				...
				<!--Main Center Content BEGIN -->
						...
						<table border="1" cellpadding="1" cellspacing="0" width="100%" bordercolor="#808080" style="border-collapse:collapse" class="tablePadd"> 
							...
							<strong>Team Listing</strong> </td></tr>
				...
				<input type="hidden" name="page" id="page" value="0">
						...
						<?
						if(!$searchname){
						$query =" Select * from ".TBL_COLLEGE_COACH; }else{
						$query ="Select * from ".TBL_COLLEGE_COACH." where 1=1 ".$srchCond;
						}
						...
						echo '<tr><td align="center" class="normalblack_12" width="4%">&nbsp;</td>
									...
									<td align="left" class="normalblack_12" width="25%">&nbsp;<strong>Team Name</strong></td>
                                   ';
						...
						for ($i=0;$i<$db->num_rows();$i++) {
							...
							echo '<tr><td align="center" class="normalblack_12">&nbsp;';
									...
									';
							   		...
							   		echo '<td class="normalblack_12" align="center"><a href="ADTeamEdit.php?mode=edit&fldId='.$db->f('fldId').'&page='.$pageno.'"><img src="images/b_edit.png" border="0" title="Edit"></a></td>';
