...
function deleteRecord(fldId,page) {
	...
	if( confirm("Are you sure to delete the banner?")) {
...
function submitDeleteAll(){
	...
	if(countChecked!=0){
		if( confirm("Are you sure to delete the selected banner?")) {
			...
			<TD bgColor=#ffffff>
				...
				<!--Main Center Content BEGIN -->
						...
						<table border="1" cellpadding="1" cellspacing="0" width="100%" bordercolor="#808080" style="border-collapse:collapse" class="tablePadd"> 
							...
							<strong>Banner Listing</strong> </td></tr>
				...
				<input type="hidden" name="page" id="page" value="0">
							...
							<input type="submit"  name="search" id="search" style="width:180px" value="Search Banner By  Title">
							</form></td></tr>
							<form name="frmPage" action="" method="post" onsubmit="">
						<?
						if(!$searchname){
						$query =" Select * from ".TBL_BANNER; }else{
						$query ="Select * from ".TBL_BANNER." where 1=1 ".$srchCond;
						}
						...
						echo '<tr><td align="center" class="normalblack_12" width="4%">&nbsp;</td>
									...
									<td align="left" class="normalblack_12" width="25%">&nbsp;<strong>Banner Title</strong></td>
									<td align="left" class="normalblack_12" width="25%">&nbsp;<strong>Banner Image</strong></td>
						...
						for ($i=0;$i<$db->num_rows();$i++) {
							...
							$fldImage=$func->output_fun($db->f('fldThirdParty'));
														
							$pageURL            = "ADPageDetails.php?fldId=$fldId";
							...
							echo '<tr><td align="center" class="normalblack_12">&nbsp;';
									...
									<td align="left" class="normalblack_12" nowrap><?php echo $fldImage; ?></td>
									<?php
							   		echo '<td class="normalblack_12" align="center"><a href="ADBannerEdit.php?mode=edit&fldId='.$db->f('fldId').'&page='.$pageno.'"><img src="images/b_edit.png" border="0" title="Edit"></a></td>';
