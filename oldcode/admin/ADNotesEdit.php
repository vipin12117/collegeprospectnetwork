...
if($_GET['mode']=='edit' AND $fldId!=""){
	#get the records
	$query =" Select * from tbl_notes where fldId =".$fldId;
...
if($_POST['isSubmit']=='save'){
	...
	$where = "fldId=".$fldId;
			...
			$db->updateRec("tbl_notes",$strDataArr, $where);
			#redirect to listing page on successfull updation
			header("Location: ADNotesList.php?page=".$_REQUEST['page']."&msg=Noteslist Updated Successfully!");
...
<!-- MAin Content Starts From Here -->
			...
			<tr height="20">
			<td valign="top" align="right" class="normalblack_12" width="30%">Discription<font color="red"> *</font> </td>
			<td valign="top"  align="center" class="normalblack_12" > : </td>
