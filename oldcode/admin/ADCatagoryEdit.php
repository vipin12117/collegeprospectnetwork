...
if($_GET['mode']=='edit' AND $fldId!=""){
	#get the records
	$query =" Select * from ".TBL_CATAGORY. " where fldId =".$fldId;
...
if($_POST['isSubmit']=='save'){
	...
	$where = "fldId=".$fldId;
			...
			$db->updateRec(TBL_CATAGORY,$strDataArr, $where);
			#redirect to listing page on successfull updation
			header("Location: ADCatagoryList.php?page=".$_REQUEST['page']."&msg=Catagory Updated Successfully!");
...
<!-- MAin Content Starts From Here -->
			...
			<input type="text" name="fldName" id="fldName" value="<?=$fldName?>" maxlength="30" style="width: 450px;" readonly>
			</td>
			</tr>
			<tr height="20">
			...
			<td valign="top"  align="center" class="normalblack_12" > : </td>
			<td valign="top" align="left" class="normalblack_12"><textarea name="fldDescription" id="fldDescription" rows="10" cols="15"  style="width: 450px;" onKeyDown="textCounter(document.frmPage.fldPageDescraption,document.frmPage.remLen2,100000)"  onKeyUp="textCounter(document.frmPage.fldPageDescraption,document.frmPage.remLen2,100000)" class="txt"><?php echo $fldDescription; ?></textarea>
            </td>
			</tr>
			<tr height="20">
			...
			<td valign="top"  align="center" class="normalblack_12" > : </td>
			<td valign="top" align="left" class="normalblack_12"> <select name="fldStatus" style="width: 450px;font-size:12px;">
