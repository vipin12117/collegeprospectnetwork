...
function deleteRecord(fldId,page) {
	...
	if( confirm("Are you sure to delete the College?")) {
			...
			<TD bgColor=#ffffff>
				...
				<!--Main Center Content BEGIN -->
						...
						<table border="1" cellpadding="1" cellspacing="0" width="100%" bordercolor="#808080" style="border-collapse:collapse" class="tablePadd"> 
							...
							<strong>College Listing</strong> </td></tr>
				...
				<input type="hidden" name="page" id="page" value="0">
						...
						<?
						if(!$searchname){
						 $query =" Select * from ".TBL_COLLEGE." where fldStatus=1"; }else{
					 $query ="Select * from ".TBL_COLLEGE." where ".$srchCond;
						}
						...
						for ($i=0;$i<$db->num_rows();$i++) {
							...
							$pageURL            = "ADCollegeNameDetails.php?fldId=$fldId";
							$detailsWindowTitle = "College Name";
							...
							echo '<tr><td align="center" class="normalblack_12">&nbsp;';
									...
									';
							   		...
							   		echo '<td class="normalblack_12" align="center"><a href="ADCollegeUpdate.php?mode=edit&fldId='.$db->f('fldId').'&page='.$pageno.'"><img src="images/b_edit.png" border="0" title="Edit"></a></td>';
