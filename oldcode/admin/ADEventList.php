...
if($_REQUEST['mode']=="del")
{
	...
	if(isset($delmsg)){
		$_REQUEST['msg']= "Event Deleted Successfully!";
...
?>
<HTML><HEAD><TITLE>Event Listing</TITLE>
...
function submitDeleteAll(){
	...
	if(countChecked!=0){
		if( confirm("Are you sure to delete the selected Event?")) {
			...
			<TD bgColor=#ffffff>
				...
				<!--Main Center Content BEGIN -->
						...
						<table border="1" cellpadding="1" cellspacing="0" width="100%" bordercolor="#808080" style="border-collapse:collapse" class="tablePadd"> 
							...
							<strong>Event Listing</strong> </td></tr>
				...
				<input type="hidden" name="page" id="page" value="0">
						...
						<?
						if(!$searchname){
						$query =" Select * from ".TBL_EVENT; }else{
						$query ="Select * from ".TBL_EVENT." where 1=1 ".$srchCond;
						}
