...
if($_POST['isSubmit']=='save'){
		...
		if($db->MatchingRec(TBL_PAGE,$whereClause)>0) {    #user Username already exists
        ...
        if($flag==0){
	 	...
	 	$db->insertRec(TBL_PAGE,$strDataArr);
			...
			header("Location: ADPageList.php?msg=Page is Added Successfully, ");
		}
...
function validate(){
	...
	//alert(document.frmPage.fldPageDescraption.value);	
	var textPageDescraption = tinyMCE.get('fldPageDescraption').getContent();
	
	if(trimString(textPageDescraption) == ""){
...
<!-- MAin Content Starts From Here -->
			...
			<td valign="top" class="normalwhite_14" colspan="4" bgcolor="#808080" align="center">
				<b>Add Content For Static Page</b>
			</td>
			</tr>
			<tr>
			<!-- Display the message on heading of the page -->
			...
			<input type="text" name="fldPageTitle" id="fldPageTitle" value="<?=$fldPageTitle?>" maxlength="30" style="width: 220px;">
			</td>
			</tr>
			<tr height="20">
			...
			<td valign="top"  align="center" class="normalblack_12" > : </td>
			<td valign="top" align="left" class="normalblack_12"><textarea name="fldPageDescraption" id="fldPageDescraption" class="txt" rows="10" cols="15"  style="width: 220px;" class="txt"><?=$fldPageDescraption?></textarea>
			...
			<input type="text" name="fldPageMetaTitle" value="<?=$fldPageMetaTitle?>" maxlength="30" style="width: 220px;">
