		...
		<TABLE cellSpacing=0 cellPadding=1 width=780 border=0>
			...
			<TD bgColor=#ffffff>
				...
				<input type="hidden" name="page" id="page" value="0">
						...
						<?
  if(!$searchname){
$query =" Select fldId,fldUserName,fldCollegecode, fldCollegename, fldCity, fldState,fldNeedType,fldCoachname from ".TBL_COLLEGE_REGISTER; }else{
$query ="Select fldId,fldUserName,fldCollegecode, fldCollegename, fldCity, fldState,fldNeedType,fldCoachname from ".TBL_COLLEGE_REGISTER." where 1=1 ".$srchCond;
						}
...
echo '</tr>';
			...
			$pageURL                  = "ADCollegeDetails.php?fldId=$fldId";
...
echo '<td class="normalblack_12" align="center"><a href="ADCollegeEdit.php?mode=edit&fldId='.$db->f('fldId').'&page='.$pageno.'"><img src="images/b_edit.png" border="0" title="Edit"></a></td>';
