			...
			<TD bgColor=#ffffff>
				...
				<!--Main Center Content BEGIN -->
						...
						<table border="1" cellpadding="1" cellspacing="0" width="100%" bordercolor="#808080" style="border-collapse:collapse" class="tablePadd"> 
							...
							<strong>Class Listing</strong> </td></tr>
				...
				<input type="hidden" name="page" id="page" value="0">
							...
							<input type="submit"  name="search" id="search" style="width:215px" value="Search Category By  Class Year">
							</form></td></tr>
							<form name="frmCatagory" action="" method="post" onsubmit="">
						<?
						if(!$searchname){
						$query =" Select * from ".TBL_CLASS; }else{
						$query ="Select * from ".TBL_CLASS." where 1=1 ".$srchCond;
						}
						...
						echo '<tr><td align="center" class="normalblack_12" width="4%">&nbsp;</td>
									...
									<td align="left" class="normalblack_12" width="25%">&nbsp;<strong>Class Year</strong></td>
                                   ';
						...
						for ($i=0;$i<$db->num_rows();$i++) {
							...
							$fldName           = $func->output_fun($db->f('fldClass'));
