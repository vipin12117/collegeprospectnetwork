...
function deleteRecord(fldId,page) {
	...
	if( confirm("Are you sure to delete the Other?")) {
...
function submitDeleteAll(){
	...
	if(countChecked!=0){
		if( confirm("Are you sure to delete the selected Other?")) {
		...
		alert("Please select at least one Other to delete");
		return false;
	}
			...
			<TD bgColor=#ffffff>
				...
				<!--Main Center Content BEGIN -->
						...
						<table border="1" cellpadding="1" cellspacing="0" width="100%" bordercolor="#808080" style="border-collapse:collapse" class="tablePadd"> 
							...
							<strong>Other Listing</strong> </td></tr>
				...
				<input type="hidden" name="page" id="page" value="0">
						...
						<?
						if(!$searchname){
						$query =" Select * from ".TBL_OTHER; }else{
						$query ="Select * from ".TBL_OTHER." where 1=1 ".$srchCond;
						}
						...
						for ($i=0;$i<$db->num_rows();$i++) {
							...
							$pageURL            = "ADOtherNameDetails.php?fldId=$fldId";
							$detailsWindowTitle = "Other Name";
							...
							echo '<tr><td align="center" class="normalblack_12">&nbsp;';
									...
									';
							   		...
							   		echo '<td class="normalblack_12" align="center"><a href="ADOtherUpdate.php?mode=edit&fldId='.$db->f('fldId').'&page='.$pageno.'"><img src="images/b_edit.png" border="0" title="Edit"></a></td>';
