		...
		$fldAddress                  = $func->output_fun($db->f('fldAddress'));
		$fldCity                     = $func->output_fun($db->f('fldCity'));
		$fldState                    = $func->output_fun($db->f('fldState'));
		$fldZipcode                  = $func->output_fun($db->f('fldZipcode'));
		$fldEnrollment                  = $func->output_fun($db->f('fldEnrollment'));
		...
		<tr>
		<td width="100%" class="SearchHead"><b>HS/AAU Team Details</b></td>
		</tr>
		<tr>
		...
		<tr>
		<td class="normalblack_12" valign="top" height="25" width="40%"><b>Enrollment</b> </td>
		<td class="normalblack_12" valign="top"><?=$fldEnrollment?></td>
		</tr>
