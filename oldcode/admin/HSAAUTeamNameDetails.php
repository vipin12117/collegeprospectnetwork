		...
		<HTML>
		<HEAD>
		<TITLE>HS AAU Team Name Details</TITLE>
		...
		<tr>
		<td width="100%" class="SearchHead"><b>HS / AAU Team Name Details</b></td>
		</tr>
		<tr>
		...
		<td class="normalblack_12" valign="top"><?=$db->f('fldAddress')?></td>
			...
			<tr>
		<td class="normalblack_12" valign="top" height="25" width="40%"><b>Contact</b> </td>
		
		<td class="normalblack_12" valign="top"><?=$db->f('fldContactInfo')?></td>
		</tr>	
		<tr>
