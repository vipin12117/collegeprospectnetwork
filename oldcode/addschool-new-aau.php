...
//$college_address_other_info=$func->selectTableOrder(TBL_HS_AAU_TEAM,"fldId,fldSchoolname,fldAddress,fldCity,fldState,fldZipcode","fldId","where fldStatus='ACTIVE' and fldSchoolname='".$txtfldName."'");


?>
<div class="yellow">    
<label>HS/AAU Name:</label>
<span style="padding-top:5px;">
	<input type="text" name="txtfldAAUName" id="txtfldAAUName" class="yellow"><!--<font color="#0000ff">&nbsp;*</font>--></span>
<label>Address:</label>
<span style="padding-top:5px;"> 	<textarea rows=14 cols=69 name=fldAAUAddress></textarea><!--<font color="#0000ff">&nbsp;*</font>--></span>
<br/>
<br/>
<label>City:</label>
<span style="padding-top:7px;">
	<input type="text" name="fldAAUCity" id="fldAAUCity" value="" >
	<!--<font color="#0000ff">&nbsp;*</font>--></span>
<br/>
<br/>
<label>State:</label>
    <span style="padding-top:5px;">
            <select name="fldAAUState">
...
<span style="padding-top:5px;">
	<input type="text" name="fldAAUZipcode" id="fldAAUZipcode" value="<?=$college_address_other_info[0]['fldZipcode']?>" >
	<!--<font color="#0000ff">&nbsp;*</font>--></span>
...
<?php
    ...
    $college_address_info=$func->selectTableOrder(TBL_HS_AAU_TEAM,"fldId,fldSchoolname,fldAddress,fldCity,fldState,fldZipcode","fldId","where fldId=".$q);

    //  print_r($college_address_info);
?>
<div class="greyed">  
<label>Address:</label>
<span style="padding-top:5px;">	<textarea rows=14 cols=69 name=fldAAUAddress readonly ><?=$college_address_info[0]['fldAddress']?></textarea><!--<font color="#0000ff">&nbsp;*</font>--></span>
<br/>
<br/>
<label>City:</label>
<span style="padding-top:6px;">
	<input type="text" name="fldAAUCity" id="fldAAUCity" value="<?=$college_address_info[0]['fldCity']?>" readonly >
	<!--<font color="#0000ff">&nbsp;*</font>--></span>
<br/>
<br/>
<label>State:</label>
	<span style="padding-top:5px;">
            <select name="fldAAUState" readonly>
               <option value="select">Select State</option>
               <optgroup label="United States">
               <option value='Alaska' <?php if ($college_address_info[0]['fldState'] == 'Alaska') echo 'selected'; ?>>Alaska</option>
               <option value='Alabama' <?php if ($college_address_info[0]['fldState'] == 'Alabama') echo 'selected'; ?>>Alabama</option>
...
<label>Zip Code:</label>
<span style="padding-top:5px;">
	<input type="text" name="fldAAUZipcode" id="fldAAUZipcode" value="<?=$college_address_info[0]['fldZipcode']?>" readonly >
	<!--<font color="#0000ff">&nbsp;*</font>-->&nbsp;</span>
	</div>
<?php
