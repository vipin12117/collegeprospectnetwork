...
if($_POST['isSubmit']=='save'){
	...
	if($_GET['fldId']!=""){
		...
		if($flag==0){
			...
			/*$delete_query_details = "delete from ".TBL_COLLEGE_SPORT_COACH." where collegeid='".$_GET['fldId']."'";
			 ...
			 for($n=0;$n<$_POST['currentrow'];$n++)
		     {
		     	   ...
		     	   
		     	   {
							...
							'fldCoachname' 		    => $func->input_fun($_POST['fldCoachname'])
							 ...
							 $db->updateRec(TBL_COLLEGE_REGISTER,$strDataArrw, $where);
							 
							 
							 $strDataArrw=array(
							'collegeid' 			=> $_GET['fldId'],
							'sportid' 			    => $func->input_fun($_POST['fldSport']),
							'coachnameid' 		    => $func->input_fun($_POST['fldCoachname'])
							 );
					  
						      
						      $db->insertRec(TBL_COLLEGE_SPORT_COACH,$strDataArrw);
		     	   }
...
*/			#redirect to listing page on successfull updation
			...
			header("Location: ADCollegeCoachList.php?page=".$_REQUEST['page']."&msg=Profile successfully updated.");
		}
	}
...
/*if(trimString(document.frmUsers.coachphone.value) == ""){
		error_msg += "Please Enter coach Phone! \n";
	}

	else if(document.frmUsers.coachphone.value.length > 10){
			error_msg += "Phone number should be less then 10 characters! \n";
		}
	
		else{
		if(!isValid(document.frmUsers.coachphone.value)){
			error_msg += "Enter valid Phone! \n";
		}
	}
	*/
	...
	/*if(trimString(document.frmUsers.fldCoachname.value) == ""){
		error_msg += "Please Select the Coach! \n";
	}
	else{
...
<p id="txtschoolothers" style="display:none; margin-top:5px;">
								<label>&nbsp;</label>
								<span>
								<!--<input type="text" name="fldOthers" id="txtschoolothers" value="<?=$fldOthers?>" style="width:200px">--></span>
								</p>
			</td>
			</tr>
			<tr height="20">				
			...
			<table align="center" id="txtHint" border="0" align="center">
			<?php
       ...
       if(($fldCollegename!="other"))
       {
         ...
         <tr height="20">
			<td valign="top" align="right" class="normalblack_12" width="30%">Address <font color="red"> *</font> </td>
         	...
         	<td valign="top"  align="center" class="normalblack_12" > : &nbsp; </td>
         	<td valign="top" align="left" class="normalblack_12"  colspan=2> 
                                    <textarea rows=5 cols=20 name=fldAddress><?=$college_address_info[0]['fldAddress']?></textarea>
</td>
			</tr>
			<tr height="20">
			...
			<td valign="top" align="right" class="normalblack_12" width="30%">City <font color="red"> *</font> </td>
         	...
         	<td valign="top"  align="center" class="normalblack_12" > : &nbsp; </td>
         	<td valign="top" align="left" class="normalblack_12"  colspan=2> 
                                    <input type="text" name="fldCity" id="fldCity" value="<?=$college_address_info[0]['fldCity']?>" style="width:183px;"> 
</td>
			</tr>
			<tr height="20">
			<td valign="top" class="normalwhite_14" colspan=4 align="center">
			...
			<td valign="top" align="right" class="normalblack_12" width="30%">State<font color="red"> *</font> </td>
         	...
         	<td valign="top"  align="center" class="normalblack_12" > : &nbsp; </td>
         	<td valign="top" align="left" class="normalblack_12"  colspan=2> 
                                    <input type="text" name="fldState" id="fldState" value="<?=$college_address_info[0]['fldState']?>" style="width:183px;" 
             >
</td>
			</tr>
			<tr height="20">
			...
			<td valign="top" align="right" class="normalblack_12" width="30%">Zip Code<font color="red"> *</font> </td>
         	...
         	<td valign="top"  align="center" class="normalblack_12" > : &nbsp; </td>
         	<td valign="top" align="left" class="normalblack_12"  colspan=2> 
                                    <input type="text" name="fldZipCode" id="fldZipCode" value="<?=$college_address_info[0]['fldZipCode']?>" style="width:183px;"
             >
</td>
			</tr>
			<tr height="20">
			...
			&nbsp;
                 ...
                 { 
                 	...
                 	$college_address_info=$func->selectTableOrder(TBL_COLLEGE,"fldId,fldName,fldAddress,fldCity,fldState,fldZipCode","fldId","where  fldId=".$other_info[0]['fldId']);?>
                 	<?php 
			...
			<td valign="top" align="right" class="normalblack_12" width="30%">College Name<font color="red"> *</font> </td>
         	...
         	<td valign="top"  align="center" class="normalblack_12" > : &nbsp; </td>
         	<td valign="top" align="left" class="normalblack_12"  colspan=2> 
                                    <input type="text" name="txtfldName" id="txtfldName" style="width:183;" value="<?=$other_info[0]['fldName']?>" readonly>
</td>
			</tr>
			<tr height="20">
			<td valign="top" class="normalwhite_14" colspan=4 align="center">
	...
	<!--ajex code End	-->
			...
			<td valign="top" align="right" class="normalblack_12" width="30%">Address<font color="red"></font></td>
			<td valign="top"  align="center" class="normalblack_12" > : </td>
			<td valign="top" align="left" class="normalblack_12">  <textarea rows=5 cols=22 name=fldAddress><?=$fldAddress?></textarea>
			...
			<!--<input type="text" name="sport" value="<?=$sport?>" maxlength="40" 
...
<option value="JUCO" <?php if($fldDivison=="JUCO"){ ?>selected <?php } ?>>JUCO</option>
		...
		<input type="button" name="backtolist" value="Back" onClick="window.location.href='ADCollegeList.php?page=<?=$pageno?>'">-->
