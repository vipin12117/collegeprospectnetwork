...
class UserController extends AppController{
	...
	public $uses = array("Athlete","HsAauTeam");
	...
	public function registerAthlete(){
		...
		if(isset($this->request->data['Athlete'])){
			...
			elseif($checkEmailExist){
				$this->Session->setFlash("This username is already assigned to another user");
			}
			else{
				$newSchool = false;
				...
				$this->Email->athleteRegisterEmail($this->request->data['Athlete'],$newSchool);
				$this->redirect(array("controller"=>"Home","action"=>"index"));
				exit;
			}
		}
