...
class ScoutReportController extends AppController {
    ...
    public function view() {
        ...
        $html .= '<br><p>' ;
        $pdf->Image('@' . $img, '', '', 30, 30, '', '', '', false, 300, '', false, false, 0, false, false, false);
        $html .= '</p>' ;
        // $html .= '<img src="' . $this->webroot . '/app/webroot/img/logo.jpg" alt="Logo" style="text-align:center;" width="200" height="250" >' ;
        ...
        if($atheletes) {
            ...
            foreach($atheletes as $i=>$athelete) {
                ...
                $athelete_html .= '<tr>
                                   <td>';
                $pdf->Image('@' . $img1, '', '', 30, 30, '', '', '', false, 300, '', false, false, 1, false, false, false) ;
                $athelete_html .=  '</td>
