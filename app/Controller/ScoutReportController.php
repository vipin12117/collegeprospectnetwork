			...
			if($atheletes) {
				...
				if($atheletes) {
					...
					foreach($atheletes as $i=>$athelete) {
						...
						if($bestgame) {
							$bestgame_name = $athelete['ScoutReport']['best_game']; //$bestgame[$athelete['ScoutReport']['best_game']] ;
						}
						
						if($othergame) {
							$othergame_name = $athelete['ScoutReport']['other_game']; //$othergame[$athelete['ScoutReport']['other_game']] ;
						}
