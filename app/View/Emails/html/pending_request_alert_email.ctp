Hi <?php echo ucfirst($firstname) . "&nbsp;" . ucfirst($lastname);?>,<br /><br />
  ...
  You are receiving this email because you have pending some network request for approval. <a href=http://www.CollegeProspectNetwork.com>www.CollegeProspectNetwork.com.</a> <br />
  <br />

  Please take a couple of minutes to login and manage your Network. <br />
  <br />
  ...
  User Type: Athlete<br />
  
  <br />
  -------------------------------------------------------- <br />
  <br />

  Thank you in advance Coach <?php echo ucfirst($firstname) . "&nbsp;" . ucfirst($lastname);?> ,<br />
  <br />
