 ...
 (function($) {
     ...
     var methods = {
            ...
            for (var i = 0, field_errors = 0; i < rules.length; i++) {
                ...
                switch (rules[i]) {
                    ...
                    case "creditCard":
                        ...
                        break;
                    case "alphaNumeric":
                        errorMsg = methods._getErrorMessage(form, field, rules[i], rules, i, options, methods._alphaNumeric);
                        break;    
                    case "condRequired":
        ...
        */
        ...
        /**
         * alphaNumeric is or not
         * @return an error string if validation failed
         */
         _alphaNumeric: function(field, rules, i, options) {
